...
<BODY>
	...
	<form action="eleven.php" method="post">
		...
		<tr>
		<td width = 400>
		 STUDENT ID:   <input type="text" name="s_id" value="<?php echo $s_id ?>" readonly>
		</td>
		<td width = 400>
		GENDER: 	<input type="text" name="s_gender"  value="<?php echo $s_gender ?>" />  
		</td>
		</tr>
